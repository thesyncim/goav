...
func TestStreamRecipeReportsAmbiguousStreams(t *testing.T) {
	...
	_, err := From(FileInput("input.ogg", strings.NewReader(""))).UseRuntime(mustNew(formats, codecs)).
		Audio().
		Decode().
...
func TestStreamRecipeCopyTapCanAttachRuntimeSink(t *testing.T) {
	...
	task, err := From(FileInput("input.ogg", strings.NewReader(""))).UseRuntime(mustNew(formats)).
		Audio().
		Copy().
...
func TestBranchCompositionRejectsConflictingDecodeConfigs(t *testing.T) {
	...
	_, err := From(FileInput("input.ogg", strings.NewReader(""))).UseRuntime(runtime).
		Audio().
		Copy().
		Branches(
			Branch("left").
