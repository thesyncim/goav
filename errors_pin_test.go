...
// fixes) or Fields (an internal invariant's explanation). BuildError exposes
// only typed Fields/Fixes for structured diagnostics; the contract is what
// makes goav errors uniformly actionable, and this pin makes regressions
// impossible.
