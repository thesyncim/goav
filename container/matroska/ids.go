...
const (
	...
	idContentEncodingOrd   ebml.ID = 0x5031
	...
	idContentEncAES        ebml.ID = 0x47e7
	idContentEncAESCipher  ebml.ID = 0x47e8
...
const (
	...
	simpleBlockLacingFixed = 0x04
	simpleBlockLacingEBML  = 0x06
