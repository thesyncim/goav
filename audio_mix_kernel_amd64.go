...
func mixS16ArchKernel() (mixS16Kernel, bool) {
	return mixS16Kernel{name: "amd64/paddsw2", fn: mixS16AMD64Kernel}, true
}

func mixS16AMD64Kernel(dst []byte, inputs [][]byte, n int) {
	...
	b := inputs[1]
	vec := n &^ 15
	mixS16Add2AMD64(dst[:vec], a[:vec], b[:vec], vec)
...
//go:noescape
func mixS16Add2AMD64(dst []byte, a []byte, b []byte, n int)
