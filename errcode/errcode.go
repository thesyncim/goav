...
// FamilyForCode returns the stable family for a goav error or diagnostic code.
...
func FamilyForCode(code Code) Family {
	...
	case ShapeConversionInserted, ShapePreferenceApplied, ShapePreferenceIgnored,
		DecodeCodecDeferred, ExplainPreflightError, PacketCopy, FrameSource,
		EventSource, DecodeRequired, EncodeRequired, StreamRule:
