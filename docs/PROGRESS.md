...
including custom-stage, resize/resample, late Opus/VP8/VP9 encode-to-endpoint,
packet-copy endpoint, packet-copy recording, and sink branches that can publish
nested runtime taps for later attachments.
...
deeper buffered runtime attachment lifecycle proof without weakening the direct
