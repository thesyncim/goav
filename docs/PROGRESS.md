...
95. Add actionable stream-selection diagnostics: ambiguous and missing stream
    ...
    Done.
96. Keep `gofmt`, `go test ./...`, allocation guards, and no-cgo hygiene green.
